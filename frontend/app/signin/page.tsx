      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="space-y-4 p-7">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button onClick={() => void signInWith("google")} disabled={busy} variant="secondary">
              <span className="flex items-center justify-center gap-2">
                {oauthLoading === "google" ? <Spinner /> : <GoogleIcon />}
                {oauthLoading === "google" ? "Connecting..." : "Google"}
              </span>
            </Button>
            <Button onClick={() => void signInWith("github")} disabled={busy} variant="secondary">
              <span className="flex items-center justify-center gap-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onKeyDown={(e) => { if (e.key === "Enter") void onSignIn(); }}
            />
          </div>
